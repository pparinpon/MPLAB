...
${OBJECTDIR}/_ext/1140681021/index.p1: D:/programdata/16F18346_Link_IC.X/index.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}/_ext/1140681021" 
	@${RM} ${OBJECTDIR}/_ext/1140681021/index.p1.d 
	@${RM} ${OBJECTDIR}/_ext/1140681021/index.p1 
	${MP_CC} --pass1 $(MP_EXTRA_CC_PRE) --chip=$(MP_PROCESSOR_OPTION) -Q -G  -D__DEBUG=1 --debugger=pickit3  --double=24 --float=24 --opt=+asm,+asmfile,-speed,+space,-debug,-local --addrqual=ignore --mode=free -P -N255 --warn=-3 --asmlist -DXPRJ_default=$(CND_CONF)  --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-osccal,-resetbits,-download,-stackcall,+clib $(COMPARISON_BUILD)  --output=-mcof,+elf:multilocs --stack=compiled:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"    -o${OBJECTDIR}/_ext/1140681021/index.p1  D:/programdata/16F18346_Link_IC.X/index.c 
	@-${MV} ${OBJECTDIR}/_ext/1140681021/index.d ${OBJECTDIR}/_ext/1140681021/index.p1.d 
	@${FIXDEPS} ${OBJECTDIR}/_ext/1140681021/index.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
